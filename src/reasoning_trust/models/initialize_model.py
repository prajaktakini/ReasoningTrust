...
# def initialize_model():import os
# import yaml
# import re
#
# from transformers import AutoTokenizer
...
# #
# #     # Initialize the vLLM engine with increased max_num_batched_tokens
# #     llm = LLM(
# #         model=DEEPSEEK_MODEL,
# #         max_model_len=29000,  # Reduced from 40960 based on error message
# #         max_num_batched_tokens=29000,  # Match with max_model_len
...
# #
# #
# # def generate_response(tokenizer, sampling_params, llm, message=None, enable_thinking=True):
...
# #         tokenize=False,
# #         add_generation_prompt=True,
# #         thinking=enable_thinking,  # Set to False to strictly disable thinking
# #     )
# #
# #     if enable_thinking:
# #         # Let model generate its own thinking
# #         if not text.rstrip().endswith("<think>"):
# #             text = text.rstrip() + "<think>\n"
# #     else:
# #         # ⭐ THIS IS WHERE THE EMPTY COT GETS ADDED ⭐
# #         if text.rstrip().endswith("<think>"):
# #             text = text.rstrip()[:-7]  # Remove auto-added <think>
# #
# #         # Add the empty CoT block to disable thinking
# #         text = text.rstrip() + "<think>\n\n</think>\n\n"  # ← THIS LINE!
# #         # print("✓ Thinking DISABLED: added empty CoT")
# #
# #     # print(f"Prompt: {text[-100:]!r}\n")
# #
# #     # Generate outputs
...
# #     tokenizer, sampling_params, llm = initialize_model()
# #
# #     # Test message
# #     message = [
...
# #
# #     print("=" * 60)
# #     print("Testing WITH enable_thinking=True")
# #     print("=" * 60)
# #     generate_response(tokenizer, sampling_params, llm, message, enable_thinking=True)
# #
# #     print("\n" + "=" * 60)
# #     print("Testing WITH enable_thinking=False")
# #     print("=" * 60)
# #     generate_response(tokenizer, sampling_params, llm, message, enable_thinking=False)
# #
# #
